...
public class IVAddItem extends PokemonUseItem {
    ...
    public ActionResult processInteraction(ItemStack itemStack, PlayerEntity player, PokemonEntity target, Pokemon pokemon) {
        ...
        player.sendMessage(Text.literal("Increased ").append(pokemon.getDisplayName(false)).append(Text.literal("'s " + statToBoost.getDisplayName().getString() + " IV by " + actualIncrease)));
